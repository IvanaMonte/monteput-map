...
const SegmentPopup = ({ segmentKey, onClose }) => {
  ...
  return (
    <div
      className="absolute top-20 right-6 z-50 bg-white p-5 rounded-xl shadow-2xl border border-gray-200 w-96 font-sans animate-fadeIn"
      style={{
    ...
    >
      ...
      <div className="mt-4 flex justify-between items-center gap-2">
        <a
          ...
          className="flex-1 text-center bg-gray-50 border border-gray-200 rounded-md px-3 py-2 text-sm hover:bg-gray-100 transition"
        >
          🎥 Video
        </a>
        <button
          className="flex-1 bg-gray-50 border border-gray-200 rounded-md px-3 py-2 text-sm hover:bg-gray-100 transition"
        >
          📄 Dokumentacija
        </button>
        <button
          onClick={onClose}
          className="bg-white border border-gray-300 rounded-md px-3 py-2 text-sm hover:bg-gray-100 transition"
        >
          ✕
        </button>
      </div>
