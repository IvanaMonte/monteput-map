...
export default function InteractiveMap() {
  ...
  return (
    <div className="w-screen h-screen bg-[#EFEFEF] flex flex-col overflow-hidden">
      ...
      {/* MAPA */}
      <main
        className={`flex-1 flex items-center justify-center overflow-hidden transition-all duration-300 ${activeSegment ? 'mb-80 md:mb-0 md:mt-[60px]' : 'sm:mt-[90px] md:mt-[60px]'}`}
        onMouseMove={(e) => {
          // === Tooltip praćenje ===
          if (!isPanning) {
